...
export function CommunityPage({books,onLibraryChanged,onOpenLibrary,onSocial}:{onSocial:()=>void;books:BookCatalogItem[];onLibraryChanged:()=>Promise<void>;onOpenLibrary:()=>void}) {
  ...
  return <div className="community-page"><section className="community-hero"><span className="kicker">一起读，走得更远</span><h2>让好内容，遇见同路人。</h2><p>分享一本好书、一篇笔记，<br/>或一个刚刚想明白的瞬间。</p><button onClick={()=>setSharing(true)}><Icon name="send" size={17}/>分享我的内容</button><Icon name="community" size={62}/></section>
